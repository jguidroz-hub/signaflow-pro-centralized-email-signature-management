...
const FROM = process.env.EMAIL_FROM || 'SignaFlow Pro - Centralized Email Signature Management <noreply@example.com>';
const APP_NAME = 'SignaFlow Pro - Centralized Email Signature Management';
