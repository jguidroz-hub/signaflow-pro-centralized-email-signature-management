...
export default function SignaturesPage() {
  const [items, setItems] = useState<SignaturesItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Email Signature Management</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Create and manage company email signatures</p>
