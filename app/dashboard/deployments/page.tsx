...
export default function DeploymentsPage() {
  const [items, setItems] = useState<DeploymentsItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Signature Distribution</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Control signature assignment across organization</p>
